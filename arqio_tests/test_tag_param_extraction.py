...
def test_tag_parameter_extraction():
    ...
    mock_raw_items = [
        {
            ...
            "extraction_text": "1 La senalizacion de las instalaciones manuales...",
            "attributes": {
                "id": "N::000003",
                "relevant_tags": [
        ...
        },
        {
            ...
            "attributes": {
                ...
                "extracted_parameters": [
                    ...
                    "ROAD.APPROACH.FIRE_BRIGADE_VEHICLE.BEARING_CAPACITY >= 20 kN/m²"
                ],
                "topics": ["SAFETY.FIRE"]
            }
        }
    ...
    for i, norm in enumerate(norms_to_process):
        print(f"  Norm {i}: ID={norm.get('id')}, Tags={len(norm.get('relevant_tags', []))}, Params={len(norm.get('extracted_parameters', []))}")
