    ...
    test_cases = [
        {
            ...
            "json": '{"extractions": [{"entity": "test", "text": "normal text"}]}',
            "should_pass": True
        },
        {
            "name": "LaTeX backslashes",
            "json": '{"extractions": [{"entity": "math", "text": "$\\\\theta$ and $\\\\mathsf{E}$"}]}',
            "should_pass": True
        },
        {
            "name": "HTML attributes",
            "json": '{"extractions": [{"entity": "table", "text": "<td colspan=\"4\">cell</td>"}]}',
            "should_pass": True
        },
        {
            "name": "Multiple HTML attributes",
            "json": '{"extractions": [{"entity": "div", "text": "<div class=\"container\" id=\"main\" style=\"color:red\">content</div>"}]}',
            "should_pass": True
        },
        {
            "name": "Mixed LaTeX and HTML",
            "json": '{"extractions": [{"math": "$\\\\pi$", "table": "<table border="1"><tr><td colspan="2">$\\\\alpha$</td></tr></table>"}]}',
            "should_pass": True
        },
        {
            "name": "Nested quotes in HTML",
            "json": '{"extractions": [{"html": "<div title=\\"Value is nested\\">content</div>"}]}',
            "should_pass": True
        },
        {
            "name": "Unicode sequences", 
            "json": '{"extractions": [{"text": "Unicode \\\\u03B1 and \\\\u03B2"}]}',
            "should_pass": True
        }
    ]
