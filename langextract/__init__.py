...
def extract(
  ...
  # Generate schema based on language model type
  ...
  if not api_key:
    ...
    if not api_key and language_model_type in [
      ...
      raise ValueError(
          ...
          " parameter or environment variables (LANGEXTRACT_API_KEY or "
          "LANGEXTRACT_OPENAI_API_KEY for OpenAI)"
      )
