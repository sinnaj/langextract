...
def demo_commenting_system():
    ...
    # Update a comment
    success = db.update_comment(created_comment.id, "This function REALLY needs better error handling!")
    if success:
    ...
    print("You can inspect the database using any SQLite browser or the Flask API.")
