...
def test_original_user_cases():
    ...
    latex_cases = [
        ...
        '{"extractions": [{"result": "Angle is $30^{\\\\circ}$ and tensor $\\\\mathsf{E}1_{2}$", "attributes": {"norm_statement": "Maintain $30^{\\\\circ}$"}}]}'
    ]
    ...
    print("2. Testing HTML content that caused 'Expecting comma delimiter' errors:")
    html_cases = [
        '{"extractions": [{"text": "<table><tr><td colspan=\\"4\\">Cell content</td></tr></table>"}]}',  # Pre-escaped (should work)
        '{"extractions": [{"text": "<table><tr><td colspan="4">Cell content</td></tr></table>"}]}',     # Unescaped (needs fixing)
        '{"extractions": [{"html": "<div class=\\"container\\"><table border=\\"1\\" cellpadding=\\"2\\"><tr><td colspan=\\"4\\" style=\\"text-align:center\\">Header</td></tr></table></div>"}]}'  # Complex case
    ]
    ...
    combined_cases = [
        '{"extractions": [{"math": "$\\\\pi$", "html": "<div class=\\"test\\">content</div>"}]}',
        '{"extractions": [{"description": "Temperature $30^{\\\\circ}$ in <span class=\\"highlight\\">red</span>"}]}',
    ]
    ...
    print("   • LaTeX backslash sequences (\\mathsf, \\circ) are properly escaped")
