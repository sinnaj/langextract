        ...
        extractions=[
            ...
            lx.data.Extraction(
                ...
                attributes={
                    ...
                    "extraction_text": (
                        "2 A efectos del computo de la superficie de un sector"
                        " de incendio, se considera que los locales de riesgo"
                        " especial, las escaleras y pasillos protegidos, los"
                        " vestibulos de independencia y las escaleras"
                        " compartmentadas como sector de incendios, que esten"
                        " contenidos en dicho sector no forman parte del mismo."
            ...
            lx.data.Extraction(
                ...
                attributes={
                    ...
                    "extraction_text": (
                        "Las superficies maximas indicadas en dicha tabla para"
                        " los sectores de incendio pueden duplicarse cuando"
                        " esten protegidos con una instalacion automatica de"
                        " extincion."
                    ),
                    "target_reference": [
                        "Table 1.1 Condiciones de compartmentacion en sectores"
            ...
            lx.data.Extraction(
                extraction_class="Parameter",
                extraction_text=(
                    "englobe varios de los usos anteriormente enunciados"
                ),
                attributes={
                    "id": "P::000005",
                    "extraction_text": (
            ...
            lx.data.Extraction(
                extraction_class="Parameter",
                extraction_text=(
                    "sea igual o superior a tres millones de me-gajulios"
                ),
                attributes={
                    "id": "P::000006",
                    "extraction_text": (
            ...
            lx.data.Extraction(
                extraction_class="Tag",
                extraction_text=(
                    "esta-blecimientos cuya superficie construida no exceda de"
                    " 500 m²"
                ),
                attributes={
                    "id": "T::000003",
                    "extraction_text": (
                        "esta-blecimientos cuya superficie construida no exceda"
                        " de 500 m²"
                    ),
            ...
            lx.data.Extraction(
                extraction_class="Tag",
                extraction_text=(
                    "los esta-blecimientos cuya superficie construida no exceda"
                    " de 500 m² y cuyo uso sea Docente, Administrativo o"
                    " Residencial Público."
                ),
                attributes={
                    "id": "T::000005",
                    "extraction_text": (
                        "los esta-blecimientos cuya superficie construida no"
                        " exceda de 500 m² y cuyo uso sea Docente,"
                        " Administrativo o Residencial Público."
                    ),
                    "tag": "ESTABLISHMENT.USAGE.PUBLIC.RESIDENTIAL",
                    "definition": (
                        "Uso público residencial de un establecimiento"
                    ),
                    "synonyms": [
                        "uso público residencial de un establecimiento"
                    ],
