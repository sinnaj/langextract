...
EXAMPLES: List[lx.data.ExampleData] = [
    ...
    lx.data.ExampleData(
        text=(
            ...
            " actividad. No se aplica a puertas automáticas con abatimiento"
            " seguro."
        ),
        extractions=[
            lx.data.Extraction(
                ...
                extraction_text=(
                    ...
                    " desactivado durante la actividad. No se aplica a puertas"
                    " automáticas con abatimiento seguro."
                ),
                attributes={
                    "paragraph_number": 1,
                    ...
                    "satisfied_if": (
                        "(DOOR.TYPE == 'SWING' AND DOOR.AXIS == 'VERTICAL' AND"
                        " DOOR.OPENING.REQUIRES_KEY == FALSE); OR"
                    ...
                    "uncertainty": 0.08,
                    "notes": (
                        "Puertas de evacuación: requisitos de abatimiento y"
                        " apertura sin llave; exención para automáticas con"
                        " abatimiento seguro."
                    ),
                    "rich_demo": {
                        "parameters": [{
        ...
        extractions=[
            lx.data.Extraction(
                ...
                attributes={
                    ...
                    "uncertainty": 0.1,
                    "notes": (
                        "Prohíbe mecanismos con llave en ruta principal para"
                        " ocupaciones altas."
                    ),
                },
            )
        ...
        extractions=[
            lx.data.Extraction(
                ...
                attributes={
                    ...
                    "relevant_tags": [
                        "ANNEX.ANEXO_III.SUBMITTED",
                        "ZONE.CODE",
                        "DOOR.OPENING.PUSH_FORCE_N",
                    ],
                    "relevant_roles": [],
                    "project_dimensions": {},
                    "lifecycle_phase": [],
                    ...
                    "uncertainty": 0.14,
                    "notes": (
                        "Requiere la presentación del Anexo III en zona R6.2"
                        " bajo condición de fuerza de apertura."
                    ),
                },
            ),
            lx.data.Extraction(
    ...
    lx.data.ExampleData(
        text=(
            "Las rutas accesibles deben estar señalizadas con pictograma"
            " normalizado."
        ),
        extractions=[
            lx.data.Extraction(
                extraction_class="Norm",
                extraction_text=(
                    "Las rutas accesibles deben estar señalizadas con"
                    " pictograma normalizado."
                ),
                attributes={
                    "paragraph_number": 1,
                    "obligation_type": "MANDATORY",
                    "applies_if": "TRUE",
                    "satisfied_if": (
                        "ROUTE.ACCESSIBLE.SIGNAGE.STANDARDIZED == TRUE"
                    ),
                    "exempt_if": None,
                    ...
                    "uncertainty": 0.1,
                    "notes": (
                        "Señalización accesible con pictograma normalizado."
                    ),
                },
            ),
            lx.data.Extraction(
                ...
                attributes={
                    ...
                    "definition": (
                        "Señalización de la ruta accesible conforme a"
                        " pictograma oficial."
                    ),
                    "status": "ACTIVE",
                },
    ...
    lx.data.ExampleData(
        text=(
            "En hospitales, las puertas automáticas deberán quedar abiertas"
            " ante fallo de energía, salvo en quirófanos con normativa"
            " específica."
        ),
        extractions=[
            lx.data.Extraction(
                extraction_class="Norm",
                extraction_text=(
                    "En hospitales, las puertas automáticas deberán quedar"
                    " abiertas ante fallo de energía, salvo en quirófanos con"
                ...
                attributes={
                    ...
                    "obligation_type": "MANDATORY",
                    "applies_if": (
                        "USAGE == 'HOSPITAL' AND DOOR.TYPE == 'AUTOMATIC'"
                    ),
                    "satisfied_if": (
                        "(DOOR.AUTOMATIC.FAIL_SAFE == 'OPEN'); OR"
                        " (SYSTEM.POWER.BACKUP == TRUE)"
                    ),
                    ...
                    "uncertainty": 0.08,
                    "notes": (
                        "En hospitales, puertas automáticas en modo fail-safe"
                        " abierto o respaldo de energía; exención quirófanos."
                    ),
                },
            ),
            lx.data.Extraction(
    ...
    lx.data.ExampleData(
        text=(
            "Se permite instalar paneles fotovoltaicos exteriores en jardín en"
            " viviendas unifamiliares privadas."
        ),
        extractions=[
            lx.data.Extraction(
                extraction_class="Norm",
                extraction_text=(
                    "Se permite instalar paneles fotovoltaicos exteriores en"
                    " jardín en viviendas unifamiliares privadas."
                ),
                attributes={
                    "paragraph_number": 1,
                    "obligation_type": "PERMISSION",
                    "applies_if": (
                        "USAGE == 'FAMILY.SINGLE' AND OWNERSHIP == 'PRIVATE'"
                    ),
                    "satisfied_if": (
                    ...
                    "uncertainty": 0.12,
                    "notes": (
                        "Permiso para FV exterior en jardín en vivienda"
                        " unifamiliar privada."
                    ),
                },
            ),
    ...
    lx.data.ExampleData(
        text=(
            "Si la obra produce cierre de calle, deberá solicitarse inspección"
            " previa municipal."
        ),
        extractions=[
            lx.data.Extraction(
                extraction_class="Norm",
                extraction_text=(
                    "Si la obra produce cierre de calle, deberá solicitarse"
                    " inspección previa municipal."
                ),
                attributes={
                    "paragraph_number": 3,
                    ...
                    "relevant_tags": [
                        "WORK.EFFECTS",
                        "INSPECTION.MUNICIPAL.REQUESTED",
                    ],
                    "relevant_roles": [],
                    ...
                    "uncertainty": 0.1,
                    "notes": (
                        "Obliga a solicitar inspección municipal cuando hay"
                        " cierre de calle."
                    ),
                },
            ),
    ...
    lx.data.ExampleData(
        text=(
            "Los elementos estructurales expuestos al viento deberán ejecutarse"
            " en acero o aluminio según normativa aplicable."
        ),
        extractions=[
            lx.data.Extraction(
                extraction_class="Norm",
                extraction_text=(
                    "Los elementos estructurales expuestos al viento deberán"
                    " ejecutarse en acero o aluminio según normativa aplicable."
                ),
                attributes={
                    "paragraph_number": 4,
                    "obligation_type": "MANDATORY",
                    ...
                    "satisfied_if": (
                        "STRUCTURE.MATERIAL IN['STEEL','ALUMINIUM']"
                    ),
                    "exempt_if": None,
                    ...
                    "uncertainty": 0.1,
                    "notes": (
                        "Material estructural permitido frente a viento: acero"
                        " o aluminio."
                    ),
                },
            ),
            lx.data.Extraction(
                ...
                attributes={
                    ...
                    "parent": "STRUCTURE",
                    "definition": (
                        "Material principal de los elementos estructurales."
                    ),
                    "status": "ACTIVE",
                },
            ),
    ...
    lx.data.ExampleData(
        text=(
            "Queda prohibida la instalación de antenas de radiocomunicación"
            " auxiliares en la zona R6.2 y áreas adyacentes a PEM2."
        ),
        extractions=[
            lx.data.Extraction(
                extraction_class="Norm",
                extraction_text=(
                    "Queda prohibida la instalación de antenas de"
                    " radiocomunicación auxiliares en la zona R6.2 y áreas"
                    " adyacentes a PEM2."
                ),
                attributes={
                    "paragraph_number": 5,
                    "obligation_type": "PROHIBITION",
                    "applies_if": (
                        "WORK.TYPE.AUXILARY == 'ELECTRO.RADIOCOMMUNICATION' AND"
                        " (LOCATION.OVERLAPS('ZONE:R6.2') OR"
                        " LOCATION.ADJACENT_TO('ZONE:PEM2'))"
                    ),
                    ...
                    "relevant_roles": [],
                    "project_dimensions": {
                        "WORK.TYPE.AUXILARY": ["ELECTRO.RADIOCOMMUNICATION"]
                    },
                    "lifecycle_phase": [],
                    "location_scope": {
                        "COUNTRY": "ES",
                    ...
                    "uncertainty": 0.12,
                    "notes": (
                        "Prohibición de antenas auxiliares en R6.2 y adyacentes"
                        " a PEM2."
                    ),
                },
            ),
    ...
    lx.data.ExampleData(
        ...
        extractions=[
            ...
            lx.data.Extraction(
                extraction_class="Norm",
                extraction_text=(
                    "En proyectos de reforma se deberá mantener la"
                    " accesibilidad existente como mínimo."
                ),
                attributes={
                    "paragraph_number": 6,
                    "obligation_type": "MANDATORY",
                    ...
                    "satisfied_if": (
                        "ACCESSIBILITY.LEVEL >= ACCESSIBILITY.EXISTING.LEVEL"
                    ),
                    "exempt_if": None,
                    "topics": ["ACCESSIBILITY"],
                    "priority": 3,
                    ...
                    "uncertainty": 0.1,
                    "notes": (
                        "En reformas, mantener como mínimo la accesibilidad"
                        " existente."
                    ),
                    "id": "N::REFS1",
                },
            ...
            lx.data.Extraction(
                extraction_class="Norm",
                extraction_text=(
                    "En proyectos nuevos se exigirá cumplimiento íntegro de"
                    " exigencias térmicas."
                ),
                attributes={
                    "paragraph_number": 7,
                    ...
                    "relevant_tags": [
                        "PROJECT.TYPE",
                        "ENERGYSAVING.THERMAL.COMPLIANCE",
                    ],
                    "relevant_roles": [],
                    ...
                    "uncertainty": 0.1,
                    "notes": (
                        "En obra nueva, cumplimiento íntegro de exigencias"
                        " térmicas."
                    ),
                    "id": "N::REFS2",
                },
    ...
    lx.data.ExampleData(
        text=(
            "Dentro del término ES.CT.BCN, la presión máxima de suministro de"
            " gas en cocinas será <= 2 bar."
        ),
        extractions=[
            lx.data.Extraction(
                extraction_class="Norm",
                extraction_text=(
                    "La presión máxima de suministro de gas en cocinas será <="
                    " 2 bar."
                ),
                attributes={
                    "paragraph_number": 8,
                    "obligation_type": "MANDATORY",
                    "applies_if": (
                        "LOCATION.WITHIN('ES.CT.BCN') AND WORK.TYPE"
                        " IN['GAS.KITCHEN']"
                    ),
                    ...
                    "uncertainty": 0.1,
                    "notes": (
                        "Presión máxima de suministro de gas en cocinas dentro"
                        " de ES.CT.BCN."
                    ),
                },
            ),
    ...
    lx.data.ExampleData(
        text=(
            "Se recomienda emplear luminarias de alta eficiencia para reducir"
        ...
        extractions=[
            lx.data.Extraction(
                extraction_class="Norm",
                extraction_text=(
                    "Se recomienda emplear luminarias de alta eficiencia para"
                ...
                attributes={
                    ...
                    "applies_if": "TRUE",
                    "satisfied_if": (
                        "ENERGYSAVINGS.LIGHTING.EFFICIENCY == 'HIGH'"
                    ),
                    "exempt_if": None,
                    ...
                    "uncertainty": 0.15,
                    "notes": (
                        "Recomendación modelada como permiso: luminarias de"
                        " alta eficiencia."
                    ),
                },
            ),
