...
### 1) Basic Section Hierarchy
        ...
        extractions=[
            lx.data.Extraction(
                ...
                """# I Amito de aplicacion El ambito de aplicacion de este DB es el que se establece con caracter general para el conjunto del CTE en su articulo 2 (Parte I) exacyendo los edificios, establecimientos y zonas de uso industrial a los que les sea de aplicacion el "Reglamento de seguridad contra incendios en los establecimientos industriales".""",
                attributes={
                    "id": "5d6cc979-3933-4d50-b095-41d82e36b84e",
                    "author": None,
                    "date": None,
                    "source": None,
                    "document_summary": "Establish rules and procedures for fire safety",
            ...
            lx.data.Extraction(
                ...
                attributes={
                    "id": "14b6191b-421d-4d93-8dca-d0bd08cf99e5",
                    ...
                    "date": None,
                    "source": None,
                    "section_summary": "Scope of application of the basic document for fire safety",
                    "applies_if": "TRUE",
                    "exempt_if": "FALSE",
                }
            ),
    ...
    debe constituir al menos un sector de incendio diferenciado, incluido el posible vesti-bulo común a diferentes salas.(5)"""),
        extractions=[
            lx.data.Extraction(
                ...
                attributes={
                    "id": "7ee1c7a0-53e1-4fb1-8bf8-f6a0a107ab5d",
                    "sectioning_type": "Headline",
                    "section_level": 2,
                    "section_title": "Compartimentación en sectores de incendio",
                    "parent_type": "Chapter",
                    "parent_id": "276b26a2-c37c-4376-81f3-a409dee92378",
                    "author": None,
                    "date": None,
                    "source": None,
            ...
            lx.data.Extraction(
                ...
                extraction_text=('2 A efectos del computo de la superficie de un sector de incendio, se considera que los locales de riesgo especial, las escaleras y pasillos protegidos, los vestibulos de independencia y las escaleras compartmentadas como sector de incendios, que esten contenidos en dicho sector no forman parte del mismo.'),
                attributes={
                    "id": "b5efb3e6-d788-468d-bdd0-15661cac010c",
                    "parent_section_id": "7ee1c7a0-53e1-4fb1-8bf8-f6a0a107ab5d",
            ...
            lx.data.Extraction(
                ...
                attributes={
                    "id": "a1b4e86b-d2dd-418e-8a24-512fd6f1d9d8",
                    "parent_section_id": "7ee1c7a0-53e1-4fb1-8bf8-f6a0a107ab5d",
            ...
            lx.data.Extraction(
                ...
                attributes={
                    "id": "d1654c1a-39de-46eb-8d75-650bd8054abe",
                    "parent_section_id": "7ee1c7a0-53e1-4fb1-8bf8-f6a0a107ab5d",
                    "paragraph_number": 1,
            ...
            lx.data.Extraction(  extraction_class="NORM",
                ...
                attributes={
                    "id": "dac48fcd-aa58-4314-8155-30015df904dd",
                    "parent_section_id": "7ee1c7a0-53e1-4fb1-8bf8-f6a0a107ab5d",
                    "paragraph_number": 1,
                    "obligation_type": "MANDATORY",
...
Este Documento Básico (DB) tiene por objeto establecer reglas y procedimientos que permiten cumplir las exigencias básicas de seguridad en caso de incendio. Las secaciones de este DB se corresponden con las exigencias básicas SI 1 a SI 6. La correcta aplicación de cada Sección supone el cumplimiento de la exigencia básica correspondiente. La correcta aplicación del conjunto del DB supone que se satisface el requisito básico "Seguridad en caso de incendio"."""),
    extractions=[
            lx.data.Extraction(
                ...
                attributes={
                    "id": "645fe7c5-d04d-4d0b-b91d-23b43d5418b2",
                    "sectioning_type": "CHAPTER",
                    ...
                    "date": None,
                    "source": None,
                    "section_summary": "Introduction to the basic document establishing rules and procedures for fire safety",
                    "applies_if": "TRUE",
                    "exempt_if": "FALSE",
                }
            ),
            lx.data.Extraction(
                ...
                attributes={
                    "id": "d431fbbf-8d3a-419b-999a-c96f88411dcd",
                    "sectioning_type": "Headline",
                    "section_level": 2,
                    "section_title": "I Objeto",
                    "parent_type": "CHAPTER",
                    "parent_id": "645fe7c5-d04d-4d0b-b91d-23b43d5418b2",
                    "author": None,
                    "date": None,
                    "source": None,
                    "section_summary": "Objective of the basic document establishing rules and procedures for fire safety",
                    "applies_if": "TRUE",
                    "exempt_if": "FALSE",
                }
            ),
